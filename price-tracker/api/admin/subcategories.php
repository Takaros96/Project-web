...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = 'INSERT INTO subcategories (id, name, parent_category_id) VALUES ';
    $inserts = [];
    ...
    $sql = rtrim($sql, ',');
    $sql .= 'ON DUPLICATE KEY UPDATE name = VALUES(name), parent_category_id = VALUES(parent_category_id)';

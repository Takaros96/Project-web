    ...
    <div class="flex flex-col items-center">
      ...
      ${
        distanceFromLatLngInMeters(
          ...
          ? `
          <a href="/offers/${store.id}" style="color:#fff;" class='inline-block px-7 py-3 mt-3 bg-purple-500 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-purple-600 hover:shadow-lg focus:bg-purple-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-700 active:shadow-lg transition duration-150 ease-in-out'>Review</a>
          <a href="/add-offer/${store.id}" style="color:#fff;" class='inline-block px-7 py-3 mt-3 bg-teal-500 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-teal-600 hover:shadow-lg focus:bg-teal-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-teal-700 active:shadow-lg transition duration-150 ease-in-out'>Add Offer</a>    
          `
          : ``
      }
    ...
    <div class="flex flex-col items-center">
      ...
      ${
        distanceFromLatLngInMeters(
          ...
          ? `
          <a href="/add-offer/${store.id}" style="color:#fff;" class='inline-block px-7 py-3 mt-3 bg-teal-500 text-white white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-teal-600 hover:shadow-lg focus:bg-teal-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-teal-700 active:shadow-lg transition duration-150 ease-in-out'>Add Offer</a>
          `
          : ``
      }
      </div>
